    ...
    function displayLoginForm() {
        const csrftoken = getCookie('csrftoken'); // Récupération du token CSRF depuis le cookie
        $('.container').html(`
            <form method="post" id="loginForm" class="form-signin">
                <input type="hidden" name="csrfmiddlewaretoken" value="${csrftoken}"> <!-- Champ caché pour le CSRF token -->
