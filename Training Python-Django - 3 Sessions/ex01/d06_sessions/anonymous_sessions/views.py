...
def home(request):
    ...
    # Convertir l'horodatage enregistré en objet datetime pour la comparaison
    ...
    return render(request, 'anonymous_sessions/home.html', {'username': request.session['username']})